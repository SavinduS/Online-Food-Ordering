        ...
        <div class="md:w-1/2 w-full">
            ...
            <form action="employeeProfileUpdate" method="post" class="space-y-5">
                ...
                <div class="flex items-center gap-2 mt-[-10px]">
                    <input type="checkbox" id="showPasswordToggle" class="h-4 w-4 text-orange-500 cursor-pointer">
                    <label for="showPasswordToggle" class="text-sm text-gray-600 cursor-pointer">Show Passwords</label>
                </div>
