...
<body class="flex items-center justify-center min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
    ...
    <div class="w-full max-w-4xl flex rounded-lg shadow-2xl overflow-hidden">
        ...
        <div class="w-1/2 p-8 bg-gray-900 text-white rounded-r-lg shadow-lg">
            ...
            <form action="UserRegServelet" method="post" class="mt-6" onsubmit="validatePasswords(event)">
                ...
                <input type="password" name="password" placeholder="Password" class="w-full mt-4 p-3 border border-gray-600 rounded-lg bg-gray-700 text-white" required>
                <input type="password" name="confirmPassword" placeholder="Confirm Password" class="w-full mt-4 p-3 border border-gray-600 rounded-lg bg-gray-700 text-white" required>
